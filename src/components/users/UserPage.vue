<template>
  <div>
    <div class="bg-white rounded-lg shadow-md p-2">
      <div class="flex justify-between items-center p-4 bg-gradient-to-br from-cyan-500 to-cyan-800 rounded">
        <div>
      ...
      <table class="min-w-full bg-white rounded-lg">
        ...
        <tr v-for="user in users" :key="user.id" class="hover:bg-gray-200">
          <td class="py-2 px-4 text-gray-700 border-b border-gray-300">{{ user.name }}</td>
          <td class="py-2 px-4 text-gray-700 border-b border-gray-300">{{ user.email }}</td>
